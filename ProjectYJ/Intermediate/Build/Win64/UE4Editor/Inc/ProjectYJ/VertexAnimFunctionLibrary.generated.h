...
public: \
	DECLARE_CLASS(UVertexAnimFunctionLibrary, UBlueprintFunctionLibrary, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/ProjectYJ"), NO_API) \
...
#define ProjectYJ_Source_ProjectYJ_FunctionLibrary_VertexAnimFunctionLibrary_h_47_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UVertexAnimFunctionLibrary); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UVertexAnimFunctionLibrary); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API UVertexAnimFunctionLibrary(UVertexAnimFunctionLibrary&&); \
	NO_API UVertexAnimFunctionLibrary(const UVertexAnimFunctionLibrary&); \
public:
...
template<> PROJECTYJ_API UClass* StaticClass<class UVertexAnimFunctionLibrary>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID ProjectYJ_Source_ProjectYJ_FunctionLibrary_VertexAnimFunctionLibrary_h
